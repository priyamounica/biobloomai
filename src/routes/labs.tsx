        ...
        <>
          ...
          <div className="space-y-6">
            <AISection
              ...
              pdfFilename="biobloomai-labs-summary.pdf"
              chat={{
                topic: "labs",
                scope: "summary",
                context: `User has ${labs.length} lab result(s)${profile.age ? `, age ${profile.age}` : ""}${profile.sex ? `, ${profile.sex}` : ""}.`,
              }}
            ...
            <AISection
              ...
              variant="accent"
              pdfFilename="biobloomai-labs-advice.pdf"
              chat={{
                topic: "labs",
                scope: "advice",
                context: `User has ${labs.length} lab result(s)${profile.age ? `, age ${profile.age}` : ""}.`,
              }}
